...
<div class="dashboard-container">
    ...
    <div class="dashboard-hero-content">
        ...
        <div class="dashboard-hero-buttons">
            ...
            <a href="#program-magang" class="dashboard-btn-primary">
                <i class="bi bi-search"></i>
                Cari Program Magang
            </a>

            <a href="#tentang-yuhlez" class="dashboard-btn-secondary">
...
<section class="dashboard-jobs-section">
